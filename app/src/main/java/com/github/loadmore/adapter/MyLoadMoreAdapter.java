...
public class MyLoadMoreAdapter extends RecyclerView.Adapter<MyLoadMoreAdapter.ViewHolder> {
    Handler handler;
    /*正常view item*/
     ...
     * @param pageSize
     */
    public MyLoadMoreAdapter(Context context, int pageSize) {
    ...
    @Override
    public MyLoadMoreAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final MyLoadMoreAdapter.ViewHolder holder, int position) {
